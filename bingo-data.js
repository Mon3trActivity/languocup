...
window.BINGO_DATA = [
  ...
  { id: 8,  level: 4, grade: "B", score: 120, title: "完美主义",       body: "全程完美作战", plated: "全程没有在关卡内让目标生命值降低过", tracker: { type: "failure", label: "完美作战状态" } },
  ...
  { id: 35, level: 1, grade: "E", score: 50, title: "隐秘藏品", body: "收集过所有类型的宝箱（普通宝箱、刺箱、怪箱、零件箱）", plated: "至少有 5 名干员被刺箱/怪箱击倒", tracker: { type: "checklist", label: "宝箱收集记录", options: BLACKFLOW_CHESTS, target: 4 } },
